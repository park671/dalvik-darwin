 ...
 */
extern inline __attribute__((gnu_inline, always_inline)) void dexProtoSetFromMethodId(DexProto* pProto,
 ...
 */
extern inline __attribute__((gnu_inline, always_inline)) const char* dexGetDescriptorFromMethodId(const DexFile* pDexFile,
 ...
 * caller.
 */
extern inline __attribute__((gnu_inline, always_inline)) char* dexCopyDescriptorFromMethodId(const DexFile* pDexFile,
