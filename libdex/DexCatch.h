...
extern inline __attribute__((gnu_inline, always_inline)) void dexCatchIteratorClear(DexCatchIterator* pIterator) {
...
extern inline __attribute__((gnu_inline, always_inline)) void dexCatchIteratorInitToPointer(DexCatchIterator* pIterator,
    const u1* pEncodedData)
{
...
extern inline __attribute__((gnu_inline, always_inline)) void dexCatchIteratorInit(DexCatchIterator* pIterator,
...
extern inline __attribute__((gnu_inline, always_inline)) DexCatchHandler* dexCatchIteratorNext(DexCatchIterator* pIterator) {
...
extern inline __attribute__((gnu_inline, always_inline)) bool dexFindCatchHandler(DexCatchIterator *pIterator,
        const DexCode* pCode, u4 address) __attribute__((always_inline)) {
