...
#include "dalvik_threads.h"      // need Android thread priorities
...
Object *dvmGetNextHeapWorkerObject(HeapWorkerOperation *op)
{
    ...
    if (obj != NULL) {
        ...
        workBits = (u_int64_t)obj & (WORKER_CLEAR | WORKER_ENQUEUE);
        assert(workBits != 0);
        obj = (Object *)((u_int64_t)obj & ~(WORKER_CLEAR | WORKER_ENQUEUE));
...
bool dvmIsValidObject(const Object* obj)
{
     ...
     */
    hc = ptr2chunk(obj);
    if (obj != NULL && ((u_int64_t)hc & (8-1)) == 0) {
